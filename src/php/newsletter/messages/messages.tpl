...
<div id="tplArchiveItem">
  <div class="panel panel-default">
    <div class="panel-heading msg-list-header">
      <span style="font-weight: bold;" class="msg-list-subject"></span> - sent on <span class="msg-list-modified"></span>
</div>
...
<div id="tplDraftItem">
  <div class="panel panel-default">
    <div class="panel-heading msg-list-header">
      <span style="font-weight: bold;" class="msg-list-subject" ></span> - modified on <span class="msg-list-modified"></span>
</div>
<div class="panel-body msg-list">
  <p class="msg-list-teaser list-group-item-text"></p>
</div>
